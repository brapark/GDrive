...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5145992463:AAGvQGetbAg6JhcIc5ouvVK0PqZKc1iZhIM' # Get it from https://t.me/BotFather
    APP_ID = '15350452' # Get it from my.telegram.org/apps
    API_HASH = '23f661ee1cbb77a0ca1920a9dab9e74b' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://tsspslgzbggcvq:fd84a15fd438a2f96e72ab8494a1378615db971f47bdbd1b9ecb95603682b54d@ec2-52-4-104-184.compute-1.amazonaws.com:5432/d4n6l8j33g0f59' # SQL Database URL / Heroku Postgres URL
